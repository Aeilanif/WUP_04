...
This p-value is 0.000236. Because 0.000236<0.05 this means that we reject the $H_0$ .
...
I conclude that there is a difference between the average score on the WORDSUM tests and levels of schooling DEGREE.  According to the anova output it shows us that there is not a significant difference in WORDSUM means across DEGREE levels.
